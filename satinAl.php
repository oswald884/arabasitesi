...
session_start();
  ...
  */
  ...
  if (isset($_POST['filtre'])){
    $sql = "SELECT * FROM stok WHERE satilik_mi = true AND durum = true";
    if ($a) {
      $sql = $sql." AND renk_id = ?";
    ...
    $stmt = $object->select("SELECT * FROM stok WHERE satilik_mi = true AND durum = true;", null);
  }
?>
<!DOCTYPE html>
                  ...
                  while($row = $stmt->fetch()){
                    ...
                    <div class="col-md-4 text-center cell-parent">
                      <div class="grid-cell">
                        ...
                        <h5> Fiyat: '.escape($row['satis_fiyati']).' <span style="font-size: 18px;">tl</span></h5>
                        <form action="satinAlTamamla.php" method="POST">
                        <button class="incele">Satin Al</button>
